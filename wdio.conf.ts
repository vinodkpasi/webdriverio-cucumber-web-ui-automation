...
export const config: any = {
    ...
    cucumberOpts: {
        ...
        require: ['./step-definitions/steps.ts', './hooks/screenshot.ts'],
    ...
    onPrepare: async function () {
        // Remove the `.tmp/ and Reports/` folder that holds the json and report files
        try{
    ...
    onComplete: function () {
        ...
        const oldPath: string = path.resolve(process.cwd(), 'Reports/report/merged-output.json');
